...
export class ClassshapeService {
  ...
  private classshapesUrl = 'http://localhost:8080/classshapes';
  ...
  postClassshape(classshapeAPI: ClassshapeAPI): Observable<ClassshapeDB> {
    return this.http.post<ClassshapeDB>(this.classshapesUrl, classshapeAPI, this.httpOptions).pipe(
      tap((newClassshape: ClassshapeDB) => this.log(`added classshape w/ id=${newClassshape.ID}`)),
      catchError(this.handleError<ClassshapeDB>('addClassshape'))
    );
  }
  ...
  updateClassshape(classshapedb: ClassshapeDB): Observable<ClassshapeDB> {
    ...
    return this.http.put(url, classshapedb, this.httpOptions).pipe(
      tap(_ => this.log(`updated classshapedb id=${classshapedb.ID}`)),
